...
Additionally, we set up a vector for the moves. 
Recall that moves are algorithms used to propose new parameter values during the MCMC simulation. 
This will make it easy if we extend the model or analysis to include additional moves or to remove some moves. 
